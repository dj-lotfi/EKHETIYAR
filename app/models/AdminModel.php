...
class AdminModel extends Model_admin 
{
    ...
    public function get($id,$table)// $table : le nom du tableau du dbb  
    {
        ...
        if($table=="Agences"||$table=="Commentaires") $ind="banque" ;
        else if($table=="banques"||$table=="banque_prestation") $ind="id_banque";
        else if($table=="a_propos")$ind="id";
        else  $ind="devise_id" ;
    ...
    public function AddDevise($devise_id,	$nom_devise	,$code_ISO,	$symbole)
    {
        ...
        if($this->findById($devise_id,"devise_id"))$this->update($devise_id,"devise_id",$Tab);
