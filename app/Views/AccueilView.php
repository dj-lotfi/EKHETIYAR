    ...
    { ?>
        <form id="SortFieldForm" onsubmit="return loadbanks()">
            <div class="sort-section">
                ...
                <input class="sort-order-toggle" type="checkbox" id="Sortasc_desc" name="Sortasc_desc" value='DESC'
                    onchange="return loadbanks()">
                    ...
                    <dl class="filters-subcategory">
                        ...
                        <dd class="criteres">
                            <ul>
                                ...
                                <ul class="checkboxes">
                                    <li>
                                        <input type="checkbox" id="<?php echo $res[1][$i] ?>"
                                            name="<?php echo 'categorie' . '_' . $j ?>" value="<?php echo $res[1][$i] ?>" checked>
                                    ...
                                    while ($i < count($res[0]) && $res[1][$i] == $categorie) {
                                        ...
                                        <li>
                                            <input type="checkbox" id="<?php echo $res[0][$i]; ?>"
                                                name="<?php echo 'filter' . '_' . $j . '_' . $i ?>" value="<?php echo $res[0][$i]; ?>">
                                            <label for="<?php echo $res[0][$i]; ?>"><?php echo $res[0][$i] ?></label>
                                            <div class="tarifs-interval">
                                                <input type="text" maxlength="6" class="low-price" id="low-price<?php echo $i; ?>"
                                                    placeholder="Min" name="<?php echo 'low-price' . '_' . $j . '_' . $i; ?>">
                                                <input type="text" maxlength="6" class="high-price" id="high-price<?php echo $i; ?>"
                                                    placeholder="Max" name="<?php echo 'high-price' . '_' . $j . '_' . $i; ?>">
                                            </div>
                                        </li>
                                        <?php
                                        $i++;
